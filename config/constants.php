<?php
    ...
    // define('DB_USER', 'yriksmfuqvblzo');
    // define('DB_PASS', '0e397bd0bcbfb3a750e8d1a5f249ea3ef569fa4fe4d8db221857043e2aff296a');
    // define('DB_PORT', '5432');
    // define('DB_NAME', 'd18ng7n9fd505o');
    // define('DB_URL', 'postgres://yriksmfuqvblzo:0e397bd0bcbfb3a750e8d1a5f249ea3ef569fa4fe4d8db221857043e2aff296a@ec2-34-232-212-164.compute-1.amazonaws.com:5432/d18ng7n9fd505o');
    // define('HEROKU_CLI', 'heroku pg:psql postgresql-curly-36834 --app charlycarecla');
