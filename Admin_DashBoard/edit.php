              ...
              <div class="panel-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo $edit['post_title']; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" value="<?php echo $edit['avatar']; ?>" placeholder="Add Image file here">
                    </div>
